...
interface Props {
  ...
  loading: boolean;
  error: string;
  userActionMode: 'create' | 'existing';
  newUsername: string;
  newEmail: string;
  newRole: 'owner' | 'taker';
  addingUser: boolean;
  ...
  onUserActionMode: (value: 'create' | 'existing') => void;
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="p-5 border-t border-slate-200 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 rounded-xl bg-slate-100 p-1">
            <button
              type="button"
              onClick={() => onUserActionMode('create')}
              className={cn(
            ...
            <button
              type="button"
              onClick={() => onUserActionMode('existing')}
              className={cn(
                'rounded-lg px-3 py-2 text-sm font-medium transition-colors',
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder={userActionMode === 'create' ? 'New username' : 'Existing username'}
          ...
          >
            ...
            {userActionMode === 'create' ? 'Create User' : 'Grant Access'}
          </button>
        </div>
      </div>
    </div>
